...
* Pycharm run configurations in the (default) `.run` folder within the repo

Open Pycharm and the generated run configurations will be available (e.g. 'Install', 'Run' and 'Unittest').

Alternatively, to run Odoo manually:
...
If you need to update Odoo sources you can run:
